...
printf("%s %s  (C) %s ZeroBeat\n"
	...
	"         do not use iw to set monitor mode\n"
	"         do not use airmon-ng to set monitor mode\n"
	"         do not use hcxdumptool in combination with tools (channel hopper), which take access to the interface (except: tshark, wireshark, tcpdump)\n"
	"\n"
	"short options:\n"
