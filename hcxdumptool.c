...
printf("%s %s  (C) %s ZeroBeat\n"
	...
	"                                     notice: this is working as a protect, an attack and a display filter\n"
	...
	"                                     notice: running this filter will let hcxdumptool protect or attack a target - it is not a display filter\n" 
