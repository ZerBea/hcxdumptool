...
#define HCX_DISABLE_DEAUTHENTICATION	2
#define HCX_DISABLE_AP_ATTACKS		3
#define HCX_DISABLE_CLIENT_ATTACKS	4
#define HCX_SILENT			5
#define HCX_GPS_DEVICE			6
#define HCX_GPSD			7
#define HCX_NMEA_NAME			8
#define HCX_EAPOL_TIMEOUT		9
#define HCX_REACTIVE_BEACON		10
#define HCX_ACTIVE_BEACON		11
#define HCX_FLOOD_BEACON		12
#define HCX_EXTAP_BEACON		13
#define HCX_INFINITY			14
#define HCX_FILTERLIST_AP		15
#define HCX_FILTERLIST_CLIENT		16
#define HCX_FILTERMODE			17
#define HCX_WEAKCANDIDATE		18
#define HCX_TOT				19
...
#define STATUS_PROBES		0b0000000000000010
#define STATUS_AUTH		0b0000000000000100
#define STATUS_ASSOC		0b0000000000001000
#define STATUS_BEACON		0b0000000000010000
...
#define DISABLE_AP_ATTACKS		0b00000001
#define DISABLE_CLIENT_ATTACKS		0b00000010
#define DISABLE_DEAUTHENTICATION	0b00000100
...
struct maclist_s
{
 ...
 int			count;
 int			status;
#define NET_BEACON		0b0000000000000001
#define NET_PROBE_RESP		0b0000000000000010
#define NET_PROBE_REQ		0b0000000000000100
#define NET_AUTH		0b0000000000001000
#define NET_ASSOC_REQ		0b0000000000010000
#define NET_ASSOC_RESP		0b0000000000100000
#define NET_REASSOC_REQ		0b0000000001000000
#define NET_REASSOC_RESP	0b0000000010000000
#define NET_M1			0b0000000100000000
#define NET_M2			0b0000001000000000
#define NET_M3			0b0000010000000000
#define NET_M4			0b0000100000000000
#define NET_PMKID		0b0001000000000000
 uint8_t		addr[6];
 uint8_t		kdversion;
 uint8_t		groupcipher;
 uint8_t		cipher;
