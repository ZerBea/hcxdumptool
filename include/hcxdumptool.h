...
#define HCXD_DISABLE_ACTIVE_SCAN	3
#define HCXD_DISABLE_DEAUTHENTICATIONS	4
#define HCXD_GIVE_UP_DEAUTHENTICATIONS	5
#define HCXD_DISABLE_DISASSOCIATIONS	6
#define HCXD_DISABLE_AP_ATTACKS		7
#define HCXD_GIVE_UP_AP_ATTACKS		8
#define HCXD_DISABLE_CLIENT_ATTACKS	9
#define HCXD_USE_GPSD			10
#define HCXD_AP_MAC			11
#define HCXD_STATION_MAC		12
#define HCXD_STATION_VENDOR		13
#define HCXD_DO_RCASCAN			14
