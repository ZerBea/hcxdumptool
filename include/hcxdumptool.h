...
#define HCXD_USE_GPSD			11
#define HCXD_AP_MAC			12
#define HCXD_STATION_MAC		13
#define HCXD_STATION_VENDOR		14
#define HCXD_DO_RCASCAN			15
#define HCXD_SAVE_RCASCAN		16
