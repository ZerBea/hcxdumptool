...
typedef struct __attribute__((__packed__))
{
 ...
 char		altitudeunit;
 int		channel;
#define AKM_WEP		0x00000001
#define AKM_TKIP	0x00000002
#define AKM_RESERVED	0x00000004
#define AKM_CCMP128	0x00000008
#define AKM_WEP104	0x00000010
#define AKM_BIPCMAC128	0x00000020
#define AKM_NOT_ALLOWED	0x00000040
#define AKM_GCMP128	0x00000080
#define AKM_GCMP256	0x00000100
#define AKM_CCMP256	010200
#define AKM_BIPGMAC128	0x00000400
#define AKM_BIBGMAC256	0x00000800
#define AKM_BIPCMAC256	0x1000
#define AKM_UNKNOWN	0x2000
#define CS_WEP		0x00010000
#define CS_TKIP		0x00020000
#define CS_RESERVED	0x00040000
#define CS_SSMP128	0x00080000
#define CS_WEP104	0x00100000
#define CS_BIPCMAC128	0x00200000
#define CS_NOT_ALLOWED	0x00400000
#define CS_GCMP128	0x00800000
#define CS_GCMP256	0x01000000
#define CS_CCMP256	0x02000000
#define CS_BIPGMAC128	0x04000000
#define CS_BIPGMAC256	0x08000000
#define CS_BIPCMAC256	0x10000000
#define CS_UNKNOWN	0x80000000
 u32		rsnie;
 u32		wpaie;
 u32		wpsie;
 u16		frequency;
